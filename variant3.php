  ...
  <body>
	 <?php
      ...
      if(isset($_POST['next']))
      {
         ...
         $result = mysqli_query($con,"INSERT INTO metrics_tbl VALUES ($db_s_id, $prev_q_no, 3, $db_q_score, '$db_time_q_sec', '$db_time_hint1_sec', '$db_time_hint2_sec', $question_series_number);");
